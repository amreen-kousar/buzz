...
var urlsToCache = [
    '/fonts/index.css',
    "/static/css/main.010032f0.css",
    '/manifest.json',
    "/static/ic_launcher-web.png",
    "/css2?family=Public+Sans:wght@400;500;600;700&display=swap",
    ...
    '/static/js/bundle.js',
    "/static/js/main.34519ee1.js",

   '/dashboard/gelathi',
   "/dashboard/planofaction",
   "/dashboard/projects",
   "/dashboard/projects/enrolledGreenMotivators",
...
//       savePostRequests(event.request.clone().url, form_data, raw)
//     }))
//   }
// });
