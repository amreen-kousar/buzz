...
const [endDate, setEndDate] = useState(new Date())
  ...
  const filtersHeaders = { 1: 'Partner', 2: 'Funders', 3: 'Project', 4: 'Operations Manager', 5: 'Trainers', 6: 'Field Associates', 12: 'Sr. Operations Manager', 13: 'Field Associate Leads', 9: 'Date Range', 7: 'Location', 10: 'Participant', 30: 'All Bus', 31: 'All Projects', 32: 'All Buzz team Members', 33: 'Management Team', 34: 'Drivers',35:'Custom Filters' }
  const setData = (value) => {
    setSelectData(value)
    if (type == 'People') {
