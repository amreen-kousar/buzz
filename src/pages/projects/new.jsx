  ...
  const apiFormHit = (async) => {
    ...
    let data = JSON.stringify({
      ...
      deadline_to_collect_the_stories:
        moment(sendForm?.deadline_to_collect_the_stories.$d)?.format('YYYY-MM-DD HH:mm:ss').replace(' ', 'T') + 'Z',
                ...
                <Card sx={{ marginTop: '20px' }}>
                  <CardContent>
                    <Stack mt={2}>
                      ...
                      <Stack mt={2}>
                        <FormGroup>
                          <RadioGroup value={leave} onChange={handleLeave}>
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" />
                            <FormControlLabel value="No" control={<Radio />} label="No" />
                          </RadioGroup>
                        </FormGroup>
                  ...
                  <CardContent>
                    ...
                    <FormGroup>
                      <FormControlLabel
                        ...
                        label="What is your goal?"
                        value={'What is your goal'}
                        onChange={(event) => handleprerequisites('the_gelathi_did_not_ask', event)}
                      />
                      <FormControlLabel
                        control={<Checkbox />}
                        label="How much will it cost?"
