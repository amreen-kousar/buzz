...
|| enterData.husbandName==""|| enterData.nameOfSHG=="" || data.education =="" || data.husbandName == ""){
  ...
  return (
    ...
    <Stack mt={1}>
        <CardContent>
        <TextField fullWidth id="fathername" required onChange={(e)=>{setEnterData({...enterData,husbandName:e?.target?.value})}}label="Father/Husband name / Mother's name" variant="outlined" />
        </CardContent>
    </Stack>
    <Stack mt={1}>
        <CardContent>
        <TextField fullWidth required id="Number" onChange={(e)=>{
