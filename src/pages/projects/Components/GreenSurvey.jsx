    ...
    <CardContent>
        ...
        <CardContent>
          ...
          <Stack mt={2}>
            <FormGroup >
              ...
              <FormControlLabel value="Water/ನೀರು" control={<Checkbox style={{color:"#595959"}} />} label="Water/ನೀರು" onChange={(event)=>handleresources("natural_resources",event)}/>
              <FormControlLabel value="MotorCycle/ಮೋಟಾರ್ ಸೈಕಲ್" control={<Checkbox style={{color:"#595959"}} />} label="MotorCycle/ಮೋಟಾರ್ ಸೈಕಲ್" onChange={(event)=>handleresources("natural_resources",event)}/>
              <FormControlLabel value="Money/ಹಣ" control={<Checkbox style={{color:"#595959"}} />} label="Money/ಹಣ" onChange={(event)=>handleresources("natural_resources",event)}/>
              <FormControlLabel value="Trees/ಮರ" control={<Checkbox style={{color:"#595959"}} />} label="Trees/ಮರ" onChange={(event)=>handleresources("natural_resources",event)}/>
              <FormControlLabel value="Borewell/ಬೋರ್ವೆಲ್" control={<Checkbox style={{color:"#595959"}} />} label="Borewell/ಬೋರ್ವೆಲ್" onChange={(event)=>handleresources("natural_resources",event)}/>
              <FormControlLabel value="House/ಮನೆ" control={<Checkbox style={{color:"#595959"}} />} label="House/ಮನೆ" onChange={(event)=>handleresources("natural_resources",event)}/>
            </FormGroup>
          </Stack>
        </CardContent>
      </Card>
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          ...
          <Stack mt={2}>
            <FormGroup>
              <FormControlLabel value="Quality of food degrading / ಆಹಾರದ ಗುಣಮಟ್ಟ ಕುಸಿಯುತ್ತಿದೆ" control={<Checkbox style={{color:"#595959"}} />} label="Quality of food degrading / ಆಹಾರದ ಗುಣಮಟ್ಟ ಕುಸಿಯುತ್ತಿದೆ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="Negatively affecting agricultural income / ಕೃಷಿ ಆದಾಯದ ಮೇಲೆ ನಕಾರಾತ್ಮಕ ಪರಿಣಾಮ ಬೀರುತ್ತಿದೆ" control={<Checkbox style={{color:"#595959"}} />} label="Negatively affecting agricultural income / ಕೃಷಿ ಆದಾಯದ ಮೇಲೆ ನಕಾರಾತ್ಮಕ ಪರಿಣಾಮ ಬೀರುತ್ತಿದೆ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="Drinking water scarcity / ಕುಡಿಯುವ ನೀರಿನ ಅಭಾವ" control={<Checkbox style={{color:"#595959"}} />} label="Drinking water scarcity / ಕುಡಿಯುವ ನೀರಿನ ಅಭಾವ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="Frequent illness in children / ಮಕ್ಕಳಲ್ಲಿ ಆಗಾಗ್ಗೆ ಅನಾರೋಗ್ಯ" control={<Checkbox style={{color:"#595959"}} />} label="Frequent illness in children / ಮಕ್ಕಳಲ್ಲಿ ಆಗಾಗ್ಗೆ ಅನಾರೋಗ್ಯ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="Bodily discomfort / ದೈಹಿಕ ಅಸ್ವಸ್ಥತೆ" control={<Checkbox style={{color:"#595959"}} />} label="Bodily discomfort / ದೈಹಿಕ ಅಸ್ವಸ್ಥತೆ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="Loss of jobs/lack of work / ಉದ್ಯೋಗ ನಷ್ಟ/ಕೆಲಸದ ಕೊರತೆ" control={<Checkbox style={{color:"#595959"}} />} label="Loss of jobs/lack of work / ಉದ್ಯೋಗ ನಷ್ಟ/ಕೆಲಸದ ಕೊರತೆ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
              <FormControlLabel value="There is no impact on my life / ನನ್ನ ಜೀವನದ ಮೇಲೆ ಯಾವುದೇ ಪರಿಣಾಮವಿಲ್ಲ" control={<Checkbox style={{color:"#595959"}} />} label="There is no impact on my life / ನನ್ನ ಜೀವನದ ಮೇಲೆ ಯಾವುದೇ ಪರಿಣಾಮವಿಲ್ಲ" onChange={(event)=>handleresources("natural_resources_impacting_your_life",event)}/>
            </FormGroup>
          </Stack>
        </CardContent>
      </Card>
  ...
  <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          ...
          <Stack mt={2}>
            <FormGroup>
              <FormControlLabel value="Excessive temperature / ಅತಿಯಾದ ತಾಪಮಾನ" control={<Checkbox style={{color:"#595959"}} />} label="Excessive temperature / ಅತಿಯಾದ ತಾಪಮಾನ" onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="Excessive cold / ವಿಪರೀತ ಚಳಿ" control={<Checkbox style={{color:"#595959"}} />} label="Excessive cold / ವಿಪರೀತ ಚಳಿ" onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="Frequent flood / ಆಗಾಗ್ಗೆ ಪ್ರವಾಹ" control={<Checkbox style={{color:"#595959"}}  />} label="Frequent flood / ಆಗಾಗ್ಗೆ ಪ್ರವಾಹ" onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="Unseasonal rainfall / ಅಕಾಲಿಕ ಮಳೆ" control={<Checkbox style={{color:"#595959"}} />} label="Unseasonal rainfall / ಅಕಾಲಿಕ ಮಳೆ" onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="Water logging / ನೀರು ಲಾಗಿಂಗ್" control={<Checkbox style={{color:"#595959"}} />} label="Water logging / ನೀರು ಲಾಗಿಂಗ್" onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="Drying up of lakes,ponds and other water bodies / ಕೆರೆಗಳು, ಕೊಳಗಳು ಮತ್ತು ಇತರ ಜಲಮೂಲಗಳು ಒಣಗುತ್ತಿವೆ" control={<Checkbox style={{color:"#595959"}} />} label="Drying up of lakes,ponds and other water bodies / ಕೆರೆಗಳು, ಕೊಳಗಳು ಮತ್ತು ಇತರ ಜಲಮೂಲಗಳು ಒಣಗುತ್ತಿವೆ"onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
              <FormControlLabel value="I don't know / ನನಗೆ ಗೊತ್ತಿಲ್ಲ" control={<Checkbox style={{color:"#595959"}} />} label="I don't know / ನನಗೆ ಗೊತ್ತಿಲ್ಲ " onChange={(event)=>handleresources('changes_happened_to_the_climate',event)}/>
            </FormGroup>
          </Stack>
        </CardContent>
      </Card>
...
{climatechangeratingError ? (
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          ...
          <Stack mt={2}>
            <FormGroup>
              <FormControlLabel value="Piped water to yard/plot / ಅಂಗಳ/ಪ್ಲಾಟ್‌ಗೆ ಪೈಪ್‌ಲೈನ್ ನೀರು" control={<Checkbox style={{color:"#595959"}} />} label="Piped water to yard/plot / ಅಂಗಳ/ಪ್ಲಾಟ್‌ಗೆ ಪೈಪ್‌ಲೈನ್ ನೀರು" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Public tap/standpipe / ಸಾರ್ವಜನಿಕ ಟ್ಯಾಪ್/ಸ್ಟ್ಯಾಂಡ್ ಪೈಪ್" control={<Checkbox style={{color:"#595959"}} />} label="Public tap/standpipe / ಸಾರ್ವಜನಿಕ ಟ್ಯಾಪ್/ಸ್ಟ್ಯಾಂಡ್ ಪೈಪ್" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Tubewell/borehole / ಕೊಳವೆಬಾವಿ" control={<Checkbox style={{color:"#595959"}} />} label="Tubewell/borehole / ಕೊಳವೆಬಾವಿ" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Protected dug well / ಚೆನ್ನಾಗಿ ಅಗೆದು ರಕ್ಷಿಸಲಾಗಿದೆ" control={<Checkbox style={{color:"#595959"}} />} label="Protected dug well / ಚೆನ್ನಾಗಿ ಅಗೆದು ರಕ್ಷಿಸಲಾಗಿದೆ" onChange={(event)=>handleresources("main_source_of_water",event)} />
              <FormControlLabel value="Unprotected dug well / ರಕ್ಷಣೆಯಿಲ್ಲದ ಬಾವಿ ತೋಡಿದ್ದಾರೆ" control={<Checkbox style={{color:"#595959"}} />} label="Unprotected dug well / ರಕ್ಷಣೆಯಿಲ್ಲದ ಬಾವಿ ತೋಡಿದ್ದಾರೆ" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Protected spring / ಸಂರಕ್ಷಿತ ವಸಂತ" control={<Checkbox style={{color:"#595959"}} />} label="Protected spring / ಸಂರಕ್ಷಿತ ವಸಂತ " onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Unprotected spring / ಅಸುರಕ್ಷಿತ ವಸಂತ" control={<Checkbox style={{color:"#595959"}} />} label="Unprotected spring / ಅಸುರಕ್ಷಿತ ವಸಂತ" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Rainwater collection / ಮಳೆನೀರು ಸಂಗ್ರಹಣೆ" control={<Checkbox style={{color:"#595959"}}/> } label="Rainwater collection / ಮಳೆನೀರು ಸಂಗ್ರಹಣೆ" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Tanker-truck / ಟ್ಯಾಂಕರ್-ಟ್ರಕ್" control={<Checkbox style={{color:"#595959"}}/> } label="Tanker-truck / ಟ್ಯಾಂಕರ್-ಟ್ರಕ್" onChange={(event)=>handleresources("main_source_of_water",event)}/>
              <FormControlLabel value="Surface water (river,dam,lake,pond,stream,canal,irrigation channels) / ಮೇಲ್ಮೈ ನೀರು (ನದಿ, ಅಣೆಕಟ್ಟು, ಸರೋವರ, ಕೊಳ, ಹೊಳೆ, ಕಾಲುವೆ, ನೀರಾವರಿ ಕಾಲುವೆಗಳು)" control={<Checkbox style={{color:"#595959"}} onChange={(event)=>handleresources("main_source_of_water",event)}/> } label="Surface water (river,dam,lake,pond,stream,canal,irrigation channels) / ಮೇಲ್ಮೈ ನೀರು (ನದಿ, ಅಣೆಕಟ್ಟು, ಸರೋವರ, ಕೊಳ, ಹೊಳೆ, ಕಾಲುವೆ, ನೀರಾವರಿ ಕಾಲುವೆಗಳು)"/>
              <FormControlLabel value="Others / ಇತರರು" control={<Checkbox style={{color:"#595959"}}/> } label="Others / ಇತರರು" onChange={(event)=>handleresources("main_source_of_water",event)}/>
            </FormGroup>
          </Stack>
        </CardContent>
      </Card>
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Ground water can be drawn to how much ever extent we want to / ಅಂತರ್ಜಲವನ್ನು ನಾವು ಎಷ್ಟು ಪ್ರಮಾಣದಲ್ಲಿ ಬಯಸುತ್ತೇವೋ ಅಷ್ಟು ಪ್ರಮಾಣದಲ್ಲಿ ಎಳೆಯಬಹುದು" control={<Radio style={{color:"#595959"}} />} label="Ground water can be drawn to how much ever extent we want to / ಅಂತರ್ಜಲವನ್ನು ನಾವು ಎಷ್ಟು ಪ್ರಮಾಣದಲ್ಲಿ ಬಯಸುತ್ತೇವೋ ಅಷ್ಟು ಪ್ರಮಾಣದಲ್ಲಿ ಎಳೆಯಬಹುದು" />
              <FormControlLabel value="The groundwater below my land solely belongs to me / ನನ್ನ ಭೂಮಿಯ ಕೆಳಗಿನ ಅಂತರ್ಜಲ ನನಗೆ ಮಾತ್ರ ಸೇರಿದ್ದು" control={<Radio style={{color:"#595959"}} />} label="The groundwater below my land solely belongs to me / ನನ್ನ ಭೂಮಿಯ ಕೆಳಗಿನ ಅಂತರ್ಜಲ ನನಗೆ ಮಾತ್ರ ಸೇರಿದ್ದು" />
              <FormControlLabel value="I should always consider the groundwater limit and other users around me before making decisions on its use / ಅದರ ಬಳಕೆಯ ಬಗ್ಗೆ ನಿರ್ಧಾರಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳುವ ಮೊದಲು ನಾನು ಯಾವಾಗಲೂ ಅಂತರ್ಜಲ ಮಿತಿ ಮತ್ತು ನನ್ನ ಸುತ್ತಲಿನ ಇತರ ಬಳಕೆದಾರರನ್ನು ಪರಿಗಣಿಸಬೇಕು" control={<Radio style={{color:"#595959"}} />} label="I should always consider the groundwater limit and other users around me before making decisions on its use / ಅದರ ಬಳಕೆಯ ಬಗ್ಗೆ ನಿರ್ಧಾರಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳುವ ಮೊದಲು ನಾನು ಯಾವಾಗಲೂ ಅಂತರ್ಜಲ ಮಿತಿ ಮತ್ತು ನನ್ನ ಸುತ್ತಲಿನ ಇತರ ಬಳಕೆದಾರರನ್ನು ಪರಿಗಣಿಸಬೇಕು" />
              <FormControlLabel value="Groundwater is a shared resource / ಅಂತರ್ಜಲವು ಹಂಚಿಕೆಯ ಸಂಪನ್ಮೂಲವಾಗಿದೆ" control={<Radio style={{color:"#595959"}} />} label="Groundwater is a shared resource / ಅಂತರ್ಜಲವು ಹಂಚಿಕೆಯ ಸಂಪನ್ಮೂಲವಾಗಿದೆ" />
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Very Unconcerned / ತುಂಬಾ ಅನ್ಕನ್ಸರ್ನ್ಡ್" control={<Radio style={{color:"#595959"}} />} label="Very Unconcerned / ತುಂಬಾ ಅನ್ಕನ್ಸರ್ನ್ಡ್" />
              <FormControlLabel value="Unconcerned/ಕಾಳಜಿಯಿಲ್ಲದ" control={<Radio style={{color:"#595959"}} />} label="Unconcerned/ಕಾಳಜಿಯಿಲ್ಲದ" />
              <FormControlLabel value="Neutral/ತಟಸ್ಥ" control={<Radio style={{color:"#595959"}} />} label="Neutral/ತಟಸ್ಥ" />
              <FormControlLabel value="Concerned/ಕಳವಳ ವ್ಯಕ್ತಪಡಿಸಿದ್ದಾರೆ" control={<Radio style={{color:"#595959"}} />} label="Concerned/ಕಳವಳ ವ್ಯಕ್ತಪಡಿಸಿದ್ದಾರೆ" />
              <FormControlLabel value="Very Concerned/ತುಂಬಾ ಕಾಳಜಿ" control={<Radio style={{color:"#595959"}} />} label="Very Concerned/ತುಂಬಾ ಕಾಳಜಿ" />
            </RadioGroup>
          </Stack>
        </CardContent>
      </Card>
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Strongly disagree / ಖಂಡಿತವಾಗಿ ಒಪ್ಪುವುದಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="Strongly disagree / ಖಂಡಿತವಾಗಿ ಒಪ್ಪುವುದಿಲ್ಲ" />
              <FormControlLabel value="Disagree / ಒಪ್ಪುವುದಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="Disagree / ಒಪ್ಪುವುದಿಲ್ಲ" />
              <FormControlLabel value="Neutral / ತಟಸ್ಥ" control={<Radio style={{color:"#595959"}} />} label="Neutral / ತಟಸ್ಥ" />
              <FormControlLabel value="Agreee / ಒಪ್ಪುತ್ತೇನೆ" control={<Radio style={{color:"#595959"}} />} label="Agreee / ಒಪ್ಪುತ್ತೇನೆ" />
              <FormControlLabel value="Strongly agree / ಬಲವಾಗಿ ಒಪ್ಪುತ್ತೇನೆ" control={<Radio style={{color:"#595959"}} />} label="Strongly agree / ಬಲವಾಗಿ ಒಪ್ಪುತ್ತೇನೆ" />
            </RadioGroup>
          </Stack>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <Stack mt={2}>
            ...
            <RadioGroup
              ...
              onChange={handleland}
            >
              <FormControlLabel value="I support Meena as she is helping society by building a school for children of tthe village/ ಹಳ್ಳಿಯ ಮಕ್ಕಳಿಗಾಗಿ ಶಾಲೆ ನಿರ್ಮಿಸುವ ಮೂಲಕ ಸಮಾಜಕ್ಕೆ ಸಹಾಯ ಮಾಡುತ್ತಿರುವ ಮೀನಾ ಅವರನ್ನು ನಾನು ಬೆಂಬಲಿಸುತ್ತೇನೆ" control={<Radio style={{color:"#595959"}} />} label="I support Meena as she is helping society by building a school for children of tthe village/ ಹಳ್ಳಿಯ ಮಕ್ಕಳಿಗಾಗಿ ಶಾಲೆ ನಿರ್ಮಿಸುವ ಮೂಲಕ ಸಮಾಜಕ್ಕೆ ಸಹಾಯ ಮಾಡುತ್ತಿರುವ ಮೀನಾ ಅವರನ್ನು ನಾನು ಬೆಂಬಲಿಸುತ್ತೇನೆ" />
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Covering up a lake and constructing a building and earn more income/ಕೆರೆ ಒತ್ತುವರಿ ಮಾಡಿ ಕಟ್ಟಡ ನಿರ್ಮಿಸಿ ಹೆಚ್ಚಿನ ಆದಾಯ ಗಳಿಸುತ್ತಿದ್ದಾರೆ" control={<Radio style={{color:"#595959"}} />} label="Covering up a lake and constructing a building and earn more income/ಕೆರೆ ಒತ್ತುವರಿ ಮಾಡಿ ಕಟ್ಟಡ ನಿರ್ಮಿಸಿ ಹೆಚ್ಚಿನ ಆದಾಯ ಗಳಿಸುತ್ತಿದ್ದಾರೆ." />
              <FormControlLabel value="Cutting trees to increase available land area for commercial activities improves standard of living / ವಾಣಿಜ್ಯ ಚಟುವಟಿಕೆಗಳಿಗಾಗಿ ಲಭ್ಯವಿರುವ ಭೂಪ್ರದೇಶವನ್ನು ಹೆಚ್ಚಿಸಲು ಮರಗಳನ್ನು ಕಡಿಯುವುದು ಜೀವನ ಮಟ್ಟವನ್ನು ಸುಧಾರಿಸುತ್ತದೆ" control={<Radio style={{color:"#595959"}} />} label="Cutting trees to increase available land area for commercial activities improves standard of living / ವಾಣಿಜ್ಯ ಚಟುವಟಿಕೆಗಳಿಗಾಗಿ ಲಭ್ಯವಿರುವ ಭೂಪ್ರದೇಶವನ್ನು ಹೆಚ್ಚಿಸಲು ಮರಗಳನ್ನು ಕಡಿಯುವುದು ಜೀವನ ಮಟ್ಟವನ್ನು ಸುಧಾರಿಸುತ್ತದೆ." />
              <FormControlLabel value="Protect trees,lakes,reduce use of chemicals on land and protect your asset/ಮರಗಳು, ಸರೋವರಗಳನ್ನು ರಕ್ಷಿಸಿ, ಭೂಮಿಯಲ್ಲಿ ರಾಸಾಯನಿಕಗಳ ಬಳಕೆಯನ್ನು ಕಡಿಮೆ ಮಾಡಿ ಮತ್ತು ನಿಮ್ಮ ಆಸ್ತಿಯನ್ನು ರಕ್ಷಿಸಿ" control={<Radio style={{color:"#595959"}} />} label="Protect trees,lakes,reduce use of chemicals on land and protect your asset/ಮರಗಳು, ಸರೋವರಗಳನ್ನು ರಕ್ಷಿಸಿ, ಭೂಮಿಯಲ್ಲಿ ರಾಸಾಯನಿಕಗಳ ಬಳಕೆಯನ್ನು ಕಡಿಮೆ ಮಾಡಿ ಮತ್ತು ನಿಮ್ಮ ಆಸ್ತಿಯನ್ನು ರಕ್ಷಿಸಿ." />
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="There is a connection between food and health/ಆಹಾರ ಮತ್ತು ಆರೋಗ್ಯದ ನಡುವೆ ಸಂಬಂಧವಿದೆ" control={<Radio style={{color:"#595959"}} />} label="There is a connection between food and health/ಆಹಾರ ಮತ್ತು ಆರೋಗ್ಯದ ನಡುವೆ ಸಂಬಂಧವಿದೆ" />
              <FormControlLabel value="There is a connection between all three/ಮೂರರ ನಡುವೆ ಸಂಬಂಧವಿದೆ" control={<Radio style={{color:"#595959"}} />} label="There is a connection between all three/ಮೂರರ ನಡುವೆ ಸಂಬಂಧವಿದೆ." />
              <FormControlLabel value="I do not see any connection between them/ಅವರ ನಡುವೆ ಯಾವುದೇ ಸಂಬಂಧವನ್ನು ನಾನು ನೋಡುತ್ತಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="I do not see any connection between them/ಅವರ ನಡುವೆ ಯಾವುದೇ ಸಂಬಂಧವನ್ನು ನಾನು ನೋಡುತ್ತಿಲ್ಲ." />
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Consuming plastic packed biscuits,chocolates and chips/ಪ್ಲಾಸ್ಟಿಕ್ ಪ್ಯಾಕ್ ಮಾಡಿದ ಬಿಸ್ಕತ್ತುಗಳು, ಚಾಕೊಲೇಟ್‌ಗಳು ಮತ್ತು ಚಿಪ್‌ಗಳನ್ನು ಸೇವಿಸುವುದು" control={<Radio style={{color:"#595959"}} />} label="Consuming plastic packed biscuits,chocolates and chips/ಪ್ಲಾಸ್ಟಿಕ್ ಪ್ಯಾಕ್ ಮಾಡಿದ ಬಿಸ್ಕತ್ತುಗಳು, ಚಾಕೊಲೇಟ್‌ಗಳು ಮತ್ತು ಚಿಪ್‌ಗಳನ್ನು ಸೇವಿಸುವುದು." />
              <FormControlLabel value="Body & hair cleansing liquids,soaps,tooth paste / ದೇಹ ಮತ್ತು ಕೂದಲು ಶುದ್ಧೀಕರಿಸುವ ದ್ರವಗಳು, ಸಾಬೂನುಗಳು, ಟೂತ್ ಪೇಸ್ಟ್" control={<Radio style={{color:"#595959"}} />} label="Body & hair cleansing liquids,soaps,tooth paste / ದೇಹ ಮತ್ತು ಕೂದಲು ಶುದ್ಧೀಕರಿಸುವ ದ್ರವಗಳು, ಸಾಬೂನುಗಳು, ಟೂತ್ ಪೇಸ್ಟ್." />
              <FormControlLabel value="Use of coal,firewood or gas for cooking / ಅಡುಗೆಗೆ ಕಲ್ಲಿದ್ದಲು, ಉರುವಲು ಅಥವಾ ಅನಿಲದ ಬಳಕೆ" control={<Radio style={{color:"#595959"}} />} label="Use of coal,firewood or gas for cooking / ಅಡುಗೆಗೆ ಕಲ್ಲಿದ್ದಲು, ಉರುವಲು ಅಥವಾ ಅನಿಲದ ಬಳಕೆ" />
              <FormControlLabel value="All of the above / ಮೇಲಿನ ಎಲ್ಲವೂ" control={<Radio style={{color:"#595959"}} />} label="All of the above / ಮೇಲಿನ ಎಲ್ಲವೂ" />
              <FormControlLabel value="None of the above / ಮೇಲಿನ ಯಾವುದೂ ಅಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="None of the above / ಮೇಲಿನ ಯಾವುದೂ ಅಲ್ಲ " />
              <FormControlLabel value="I don't know/ನನಗೆ ಗೊತ್ತಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="I don't know/ನನಗೆ ಗೊತ್ತಿಲ್ಲ" />
            </RadioGroup>
          </Stack>
        </CardContent>
      </Card>
    ...
    null}
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          ...
          <Stack mt={2} mb={2}>
            <TextField id="Answ" color="common" label="Your Answer" variant="outlined" onChange={(e) => setSendData({ ...sendData, achieve_with_regard_to_natural_resource_conservation: e?.target?.value })} value={sendData?.achieve_with_regard_to_natural_resource_conservation}/>
          </Stack>
        </CardContent>
      </Card>
      ...
      <Card style={{ marginTop: 40, backgroundColor: '#F6F8FB', borderRadius: 20 }}>
        <CardContent>
          <Stack mt={2}>
            ...
            >
              <FormControlLabel value="Strongly Agree/ಬಲವಾಗಿ ಒಪ್ಪುತ್ತೇನೆ" control={<Radio style={{color:"#595959"}} />} label="Strongly Agree/ಬಲವಾಗಿ ಒಪ್ಪುತ್ತೇನೆ" />
              <FormControlLabel value="Agree / ಒಪ್ಪುತ್ತೇನೆ" control={<Radio style={{color:"#595959"}} />} label="Agree / ಒಪ್ಪುತ್ತೇನೆ" />
              <FormControlLabel value="Neutral / ತಟಸ್ಥ" control={<Radio style={{color:"#595959"}} />} label="Neutral / ತಟಸ್ಥ" />
              <FormControlLabel value="Disagree / ಒಪ್ಪುವುದಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="Disagree / ಒಪ್ಪುವುದಿಲ್ಲ" />
              <FormControlLabel value="Strongly Disagree / ಖಂಡಿತವಾಗಿ ಒಪ್ಪುವುದಿಲ್ಲ" control={<Radio style={{color:"#595959"}} />} label="Strongly Disagree / ಖಂಡಿತವಾಗಿ ಒಪ್ಪುವುದಿಲ್ಲ" />
