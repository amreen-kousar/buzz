  ...
  return (
    <div>
      ...
      >
        ...
        {!Trainingdata && batch?.all_participants?.filter((itm) => itm?.isSurveyDone == true ).map((itm) =>{
          return (
            <Stack style={{ top: 100 }}>
              <Card >
                <CardContent >
...
{Trainingdata && Trainingdata?.all_participants?.filter((itm)=>itm?.isSurveyDone==true).map((itm)=> {
          return (
            <Stack style={{ top: 100 }}>
