...
export default function EditParticipantdata({
  editSession,
  setEditsession,
  Trainingdata,
  changeState,
            ...
            <DialogContentText id="scroll-dialog-description" tabIndex={-1}>
              <FormControl fullWidth>
                ...
                <InputLabel
                  ...
                  style={{ flexDirection: 'row', color: '#ed6c02', fontWeight: 700, marginTop: 20 }}
                >
                  {sendData?.occupation == '' ? "Select wife's occupation" : 'Wife occupation'}
                </InputLabel>{' '}
                <br />
                <br />
                <Select
                  labelId="Select Wife's Occupation"
                  id="demo-simple-select"
                  value={sendData?.occupation}
                  label="Wife Occupation"
                  onChange={(e) => setSendData({ ...sendData, occupation: e?.target?.value })}
                  variant="standard"
                  color="common"
                >
              ...
              <FormControl fullWidth>
                ...
                <InputLabel
                  id="demo-simple-select-label"
                  style={{ flexDirection: 'row', color: '#ed6c02', fontWeight: 700, marginTop: 30 }}
                >
                  {sendData?.husbandOccupation == '' ? "Select Husband's occupation" : 'Husband occupation'}
                </InputLabel>{' '}
                <br />
                <br />
                <br />
                <Select
                  ...
                  onChange={(e) => setSendData({ ...sendData, husbandOccupation: e?.target?.value })}
                  variant="standard"
                  color="common"
                >
                  {occupationdata?.list?.map((itm) => {
              ...
              <Stack style={{ marginTop: 20 }}>
                <TextField
                  ...
                  id="Monthly-income"
                  onChange={(e) => {
                    setSendData({ ...sendData, wifeIncomeMonthly: e?.target?.value });
                  }}
                  label="Monthly Wife's income"
                  variant="outlined"
                  color="common"
                />
              </Stack>
              <Stack style={{ marginTop: 20 }}>
                <TextField
                  ...
                  id="Monthly-savings"
                  onChange={(e) => {
                    setSendData({ ...sendData, wifeSavingsMonthly: e?.target?.value });
                  }}
                  label="Monthly Wife's Savings"
                  variant="outlined"
                  color="common"
                />
              </Stack>
              <Stack style={{ marginTop: 20 }}>
                <TextField
                  ...
                  id="goal"
                  onChange={(e) => {
                    setSendData({ ...sendData, saving_goal: e?.target?.value });
                  }}
              ...
              <Stack style={{ marginTop: 20 }}>
                <TextField
                  required
                  id="Monthly _family_savings"
                  onChange={(e) => {
                    setSendData({ ...sendData, saving_amt: e?.target?.value });
                  }}
                  label="Monthly Family Savings"
                  variant="outlined"
                  color="common"
                />
              </Stack>
              <Stack style={{ marginTop: 20 }}>
                <TextField
                  ...
                  onChange={(e) => {
                    setSendData({ ...sendData, typeOfEnterprise: e?.target?.value });
                  }}
              ...
              <Stack mt={1}>
                ...
                <RadioGroup
                  ...
                  onChange={(e, value) => {
                    setSendData({ ...sendData, bank_acc: value });
                  }}
                  required
                >
              ...
              <Stack id="create-poa-stack" direction={'row'}>
                <Typography id="all-day">Suggested Gelathi</Typography>
                <br />
                <Switch
                  id="switch-suggested-gelathi"
                  value={sendData?.gelathiRecomm}
                  onChange={(e) => {
