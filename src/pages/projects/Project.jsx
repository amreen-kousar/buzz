            ...
            <Grid item xs={12} sm={12} md={7}>
              ...
              userDetails == 13 ? (
                ...
                <>
                  ...
                  >
                    <span>
                      Driver: {data1?.driver_name}
                      <Iconify
                        style={{ color: 'black', float: 'right', right: 10, width: 20, height: 20 }}
                        icon="material-symbols:add"
                      />
                    </span>
                  </Card>
                ...
                <ButtonGroup orientation="vertical" style={{ boxShadow: 'none', borderRadius: '0px' }} elevation={0}>
                  ...
                  {userDetails == 1 || userDetails == 4 || userDetails == 3 || userDetails == 5 || userDetails == 12 ? (
                    <Link
                      ...
                      state={{ id: data1?.project_id, type: 'SelfShakthi' }}
                      style={styles.linkStyle}
                    >
                      <Button
                        variant="secondary"
                  ...
                  {userDetails == 13 || userDetails == 4 || userDetails == 12 ? (
                    <div>
                      <Link
                        to="/dashboard/projects/assignbatches"
                        state={{ id: data1?.project_id }}
                        style={styles.linkStyle}
                      >
                        <Button
