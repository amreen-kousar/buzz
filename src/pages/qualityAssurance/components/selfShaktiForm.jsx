...
export default function SelfShaktiForm()
{
    ...
    setChecked(tempData);
      ...
      <AppBar sx={{ position: 'relative', bgcolor: '#ff7424' }}>
          <Toolbar>
             ...
             Buzz training quality assessment form
          </Typography>
        ...
        <DialogContent dividers={scroll === 'paper'} sx={{ background: "#f9fafb" }}>
          ...
          >
       <Grid>
        <Typography variant="h5" style={{textAlign:"center"}}>Buzz training quality assessment form</Typography>
