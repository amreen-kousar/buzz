  ...
  return (
    <div>
      <Card style={{ marginTop: 20 }}>
        <CardContent>
          <Typography style={{ flexDirection: 'row', color: '#ff7424' }} variant="subtitle1" gutterBottom>State
        ...
        <Button style={{ float: "right", color: 'white', marginRight: '110px', marginBottom: '10px', backgroundColor: '#ff7424' }}
